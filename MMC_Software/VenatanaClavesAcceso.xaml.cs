...
namespace MMC_Software
{
    ...
    public partial class VentanaClavesAcceso : UserControl
    {
        ...
        private string _ClaveInventarios;
        ...
        private void BtnGuardar_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (pwdClaveInventario.Password == "*****")
                {
                    ClaveInventarios = _ClaveInventarios;
                }
                else
                {
                    ClaveInventarios = RespositorioBCryp.HashPassword(pwdClaveInventario.Password);
                }


                var claves = new RepositorioClavesAcceso(_ConexionSql);
                bool Actualizo = claves.UpdateClaves(ClavePos, ClaveUsuarios, ClaveClaves,ClaveInventarios);
                if (Actualizo == true)
                {
