...
namespace MMC_Software
{
    ...
    public partial class VentanaDevueltasVentas : Window
    {
        ...
        public decimal _ValorRecibido = 0;

        public decimal _ValorDevueltas = 0;


        public VentanaDevueltasVentas(decimal ValorAPagar)
        {
            InitializeComponent();
        ...
        private void Button2k_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                decimal ValorActual = _ValorRecibido;
        ...
        private void MostrarValorDevuletas()
        {
            ...
            {
                string Signo = "$";
                decimal Recibido = _ValorRecibido;
                decimal ValorAPagar = _ValorAPagar;

                decimal Devueltas = Recibido - ValorAPagar;
        ...
        private void TxtValorRecibido_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                decimal ValorDigitado = Convert.ToDecimal(TxtValorRecibido.Text);
                string Signo = "$";
